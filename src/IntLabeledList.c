...
//=============================================================================
IntLabeledCell* createIntLabeledCell(int elem, int label, int treeId)
{
    IntLabeledCell *node;
...
bool insertIntLabeledListAt(IntLabeledList **list, int elem, int index, int label, int treeId)
{
    if(isIntLabeledListEmpty(*list))
    ...
    new_cell = createIntLabeledCell(elem, label, treeId);
...
{    
    return insertIntLabeledListAt(list, elem, 0, label, treeId);
}
...
inline bool insertIntLabeledListTail(IntLabeledList **list, int elem, int label, int treeId)
{
    if(isIntLabeledListEmpty(*list)){
        ...
        return insertIntLabeledListAt(list, elem, (*list)->size, label, treeId);   
    }
}
